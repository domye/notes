...
var _sfc_main14 = defineComponent({
  ...
  setup(__props) {
    ...
    const finalIcon = computed(() => {
      if (!isString2(__props.icon)) return toRaw(__props.icon);
    ...
    const fontIconType = computed(() => {
      ...
      if (!isString2(__props.icon)) return "";
    ...
    const isSvgIcon = computed(() => isString2(__props.icon) && (__props.iconType === "svg" || __props.icon.startsWith("svg-") || isString2(__props.icon)));
    const isSvgIconHtml = computed(() => {
      var _a;
      return isString2(__props.icon) && ((_a = __props.icon) == null ? void 0 : _a.includes("<svg"));
    });
    const isFontIcon = computed(() => isString2(__props.icon) && fontIconType.value);
    const isComponent2 = computed(
      () => !isString2(__props.icon) && (__props.iconType === "component" || isObject2(__props.icon) && ("setup" in __props.icon || "render" in __props.icon) || typeof __props.icon === "function")
    );
    const isIconifyOffline = computed(() => !isString2(__props.icon) && (__props.iconType === "iconifyOffline" || "body" in __props.icon));
    const isIconifyOnline = computed(() => isString2(__props.icon) && (__props.iconType === "iconifyOnline" || __props.icon.includes(":")));
    const isImage = computed(
      () => isString2(__props.icon) && (__props.iconType === "img" || __props.icon.toLowerCase().startsWith("img-") || [".png", ".jpg", ".jpeg", ".gif", ".bmp", ".webp"].some((ext) => __props.icon.endsWith(ext)))
    );
    return (_ctx, _cache) => {
      return !isFontIcon.value && !isImage.value && !isSvgIconHtml.value ? (openBlock(), createElementBlock(
        ...
        [
          ...
          }, null, 8, ["icon"])) : isIconifyOnline.value ? (openBlock(), createBlock(_sfc_main13, {
            key: 3,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isSvgIcon.value ? (openBlock(), createBlock(_sfc_main10, {
            key: 4,
            icon: finalIcon.value
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns4).b(), unref(ns4).join("center"), "flx-space-y-20"])
        },
        [
          createBaseVNode(
            "div",
          ...
          effect.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(DemoComponent)), { key: 1 })) : (openBlock(), createElementBlock(
            ...
            [
              ...
              createVNode(Transition, {
                name: unref(ns4).join("fade-linear"),
                persisted: ""
              }, {
                default: withCtx(() => [
...
// node_modules/vitepress-theme-teek/es/components/common/Icon/src/SocialIcons.mjs
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("p", {
          class: normalizeClass(unref(ns4).e("desc")),
...
var _hoisted_221 = ["href", "aria-label"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(bannerConfig).features.length ? (openBlock(), createBlock(TransitionGroup, {
        key: 0,
        name: unref(ns4).join("slide-next"),
        tag: "div",
        class: normalizeClass([unref(ns4).b(), unref(ns4).join("wallpaper-outside"), "flx-wrap-between"]),
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(unref(bannerConfig).features, (feature, index2) => {
              return withDirectives((openBlock(), createElementBlock("div", {
                ...
                ], 8, _hoisted_221)) : createCommentVNode("v-if", true)
              ], 10, _hoisted_126)), [
...
var _sfc_main38 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const pointClass = ns4.join("pointer");
    const { t } = useLocale();
    const emit = __emit;
    ...
    const transitionName2 = ref(ns4.join("scroll"));
    const pagination = (to, type2) => {
      emit("pagination", to, type2);
      transitionName2.value = ns4.join(`slide-${type2}`);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode(
          "div",
          {
            class: normalizeClass([unref(ns4).e("content"), unref(ns4).join("wallpaper-outside"), "flx-start-justify-center"])
          },
          [
            createBaseVNode("div", {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(footerInfo) || unref(social).length ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass([unref(ns4).b(), unref(ns4).join("wallpaper-outside")]),
        role: "contentinfo",
...
var _sfc_main64 = defineComponent({
  ...
  setup(__props) {
    ...
    const initPageStyle = async () => {
      if (!isClient) return;
      await nextTick();
      const tkLayoutDom = document.querySelector(`.${ns4.join("layout")}`);
      ["default", "card", "card-nav", "segment", "segment-nav"].forEach(
        (item) => tkLayoutDom == null ? void 0 : tkLayoutDom.classList.remove(ns4.join(item))
      );
      tkLayoutDom == null ? void 0 : tkLayoutDom.classList.add(ns4.join(themeConfig.value.pageStyle));
    };
...
var _sfc_main67 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const popoverContainerId = ns4.join("popover-container");
    onBeforeMount(() => {
...
var _sfc_main69 = defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      initJs();
      initCss();
      twikooJs.value && vpRouter.bindAfterRouteChange(ns4.join("twikoo"), (href) => reloadTwikoo(href));
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
  ...
  setup(__props) {
    ...
    onMounted(() => {
      if (!initArtalkByInject() && server) {
        initJs();
        return artalk.value && vpRouter.bindAfterRouteChange(ns4.join("artalk"), () => reloadArtalk());
      }
      console.error(
...
var _sfc_main71 = defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      reloadGiscus();
      vpRouter.bindAfterRouteChange(ns4.join("giscus"), () => {
        reloadGiscus();
      });
    });
    return (_ctx, _cache) => {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      if (!initWalineByInject() && serverURL && jsLink) {
        ...
        preventJump();
        return vpRouter.bindAfterRouteChange(ns4.join("waline"), () => waline == null ? void 0 : waline.update());
      }
      console.error(
...
// node_modules/vitepress-theme-teek/es/components/theme/CodeBlockToggle/src/createOverlay.mjs
var createOverlay = (onClick) => {
  const container = document.createDocumentFragment();
  const app = createApp(_sfc_main73, { onClick }).mount(container);
  return app.$el;
};
  ...
  setup(__props) {
    ...
    const initCodeBlock = () => {
      ...
      Array.from(modes).forEach((item) => {
        ...
        copyDom == null ? void 0 : copyDom.addEventListener("click", () => {
          var _a2, _b;
        ...
        if ((className == null ? void 0 : className.includes("details")) || (className == null ? void 0 : className.includes(ns4.join("vp-code")))) return;
    ...
    const addClickEvent = (arrowDom, codeDom) => {
      ...
      const codeBlockState = {
        ...
        fold: {
          height: codeBlockConfig.value.overlay ? addUnit(codeBlockConfig.value.overlayHeight) ?? "400px" : ns4.cssVar("code-block-fold-height"),
  ...
  setup(__props) {
    ...
    const scrollToTop = useDebounce(
      () => {
        ...
        setTimeout(() => {
          var _a2, _b;
          (_b = (_a2 = backTopConfig.value).done) == null ? void 0 : _b.call(_a2, message);
        }, 600);
      },
      500,
      true
        ...
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default", {
            ...
            withDirectives(createBaseVNode("div", {
              ...
              class: normalizeClass([unref(ns2).e("button"), "back-top"]),
              onClick: _cache[0] || (_cache[0] = //@ts-ignore
              (...args) => unref(scrollToTop) && unref(scrollToTop)(...args)),
              style: normalizeStyle({ [unref(ns2).cssVarName("progress")]: progress.value }),
              role: "button",
              ...
              unref(backTopConfig).content === "progress" ? (openBlock(), createElementBlock(
                ...
                1
                /* TEXT */
              )) : unref(backTopConfig).content === "icon" ? (openBlock(), createBlock(unref(_sfc_main14), {
                key: 1,
                icon: unref(rocketIcon),
                "aria-hidden": "true"
              }, null, 8, ["icon"])) : createCommentVNode("v-if", true)
  ...
  setup(__props) {
    ...
    const scrollToComment = useDebounce(
      () => {
        var _a;
        if (!isClient) return;
        (_a = document.querySelector(`#${ns2.join("comment")}`)) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
        setTimeout(() => {
          var _a2, _b;
          (_b = (_a2 = toCommentConfig.value).done) == null ? void 0 : _b.call(_a2, message);
        }, 600);
      },
      500,
      true
...
var docMaxWidthVar = ns3.cssVarName("doc-max-width");
var layoutModeStorageKey = ns3.storageKey("layoutMode");
var pageMaxWidthSlideStorageKey = ns3.storageKey("pageMaxWidthSlide");
var docMaxWidthSlideStorageKey = ns3.storageKey("docMaxWidthSlide");
var themeColorStorageKey = ns3.storageKey("themeColor");
var themeBgColorStorageKey = ns3.storageKey("themeBgColor");
var spotlightStorageKey = ns3.storageKey("spotlight");
var spotlightStyleStorageKey = ns3.storageKey("spotlightStyle");

// node_modules/vitepress-theme-teek/es/components/theme/RightBottomButton/src/ThemeColor.vue2.mjs
var _hoisted_156 = ["title", "aria-label"];
var _hoisted_242 = ["onClick", "aria-label"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main67), {
        class: normalizeClass(unref(ns2).e("button")),
        "popper-class": unref(ns2).e("dropdown"),
        placement: "left-start",
        width: 120,
        "x-offset": 15,
        "transition-name": unref(ns2).join("fade-scale"),
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(themeColorList2.value, (item) => {
              return openBlock(), createElementBlock("ul", {
                ...
                createBaseVNode("li", {
                  class: normalizeClass(`${unref(ns2).e("dropdown__title")} sle`),
                  title: item.tip,
                  "aria-label": item.label
                }, toDisplayString(item.label), 11, _hoisted_156),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns2).b(), unref(ns2).join("wallpaper-outside"), "flx-column"])
        },
        [
          renderSlot(_ctx.$slots, "teek-right-bottom-before"),
          unref(backTopConfig).enabled ? (openBlock(), createBlock(_sfc_main75, { key: 0 }, {
          ...
          !disabledThemeColor.value ? (openBlock(), createBlock(_sfc_main77, { key: 2 })) : createCommentVNode("v-if", true),
          ...
          [
            renderSlot(_ctx.$slots, "header", {}, () => [
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_424, [
                  createVNode(unref(_sfc_main14), {
                    icon: unref(noticeConfig).noticeIcon,
                    color: "#ffffff",
                    size: "20px",
                ...
                createVNode(unref(_sfc_main14), {
                  ...
                  color: "#ffffff",
                  size: "20px",
                  class: normalizeClass(unref(ns4).join("pointer")),
      ...
      return openBlock(), createBlock(unref(_sfc_main67), {
        ...
        default: withCtx(() => [
          createBaseVNode(
            "div",
            {
              class: normalizeClass(unref(ns3).e("helper__popup"))
            },
            [
              renderSlot(_ctx.$slots, "default")
            ],
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
            ...
            _ctx.helper ? (openBlock(), createBlock(_sfc_main83, {
              ...
              default: withCtx(() => [
                createBaseVNode(
                  "div",
                  {
                    class: normalizeClass(unref(ns3).e("helper__body"))
                  },
                  [
                    createBaseVNode(
                      "h4",
                      {
                        class: normalizeClass(unref(ns3).em("helper", "title"))
                      },
                      [
                    ...
                    createBaseVNode(
                      "p",
                      {
                        class: normalizeClass(unref(ns3).em("helper", "desc"))
                      },
                      [
                    ...
                    (openBlock(true), createElementBlock(
                      ...
                      renderList(_ctx.tips, (tip, index2) => {
                        return openBlock(), createElementBlock(
                          ...
                          {
                            key: index2,
                            class: normalizeClass(unref(ns3).e("helper__body__tip"))
                          },
                          [
        ...
        _ctx.borderHighlight ? (openBlock(), createBlock(_sfc_main84, {
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["active"])) : (openBlock(), createElementBlock("div", _hoisted_425, [
          renderSlot(_ctx.$slots, "default")
        ]))
      ]);
    };
...
var _sfc_main86 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a2;
      return openBlock(), createBlock(_sfc_main85, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => {
          var _a2;
          return [
            withDirectives(createVNode(_sfc_main85, {
              ...
              default: withCtx(() => [
                createVNode(unref(_sfc_main87), {
                  ...
                  max: max.value,
                  format,
                  class: normalizeClass(unref(ns3).e("slide")),
...
var _sfc_main89 = defineComponent({
  ...
  setup(__props) {
    ...
    const updateMaxWidth = (val) => {
      ...
      if (!shouldActivateMaxWidth.value) bodyStyle.setProperty(ns3.join("page-max-width"), `100%`);
...
var _sfc_main91 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a2;
      return openBlock(), createBlock(_sfc_main85, {
        class: normalizeClass(unref(ns3).e("theme-color")),
      ...
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        props.enabled && !shouldRecalculate.value ? (openBlock(), createElementBlock(
          "div",
          {
            ...
            class: normalizeClass([
              unref(ns3).join("spotlight-hover"),
              unref(spotlightStyle) === unref(SpotlightStyle).Under ? unref(ns3).join("spotlight-hover__under") : "",
              unref(spotlightStyle) === unref(SpotlightStyle).Aside ? unref(ns3).join("spotlight-hover__aside") : ""
            ]),
            "aria-hidden": "true",
            focusable: "false"
          },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          unref(spotlight) && !unref(supportTouch) ? (openBlock(), createBlock(_sfc_main92, {
            key: 0,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, { name: unref(transitionName) }, {
        default: withCtx(() => {
          var _a2;
          return [
            unref(spotlightToggledOn) ? (openBlock(), createBlock(_sfc_main85, {
              key: 0,
              icon: unref(clickIcon),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !unref(isMobile) && unref(themeEnhanceConfig).position === "top" ? (openBlock(), createBlock(unref(_sfc_main67), {
        key: 0,
        class: normalizeClass([unref(ns3).b(), "flx-align-center"]),
        "popper-class": unref(ns3).e("popover"),
        "y-offset": -15
      }, {
        reference: withCtx(() => [
          createVNode(unref(_sfc_main14), {
        ...
        default: withCtx(() => [
          createBaseVNode(
            "div",
            {
              class: normalizeClass(unref(ns3).e("content"))
            },
            [
              ...
              !disabledList.value.layoutSwitch ? (openBlock(), createElementBlock(
                ...
                { key: 0 },
                [
                  createVNode(_sfc_main86),
                  createVNode(_sfc_main88),
                  createVNode(_sfc_main89)
                ],
                64
                /* STABLE_FRAGMENT */
              )) : createCommentVNode("v-if", true),
              !disabledList.value.themeColor ? (openBlock(), createBlock(_sfc_main91, { key: 1 })) : createCommentVNode("v-if", true),
              !disabledList.value.spotlight ? (openBlock(), createElementBlock(
                Fragment,
                { key: 2 },
                [
                  createVNode(_sfc_main93),
                  createVNode(_sfc_main94)
                ],
                64
                /* STABLE_FRAGMENT */
              )) : createCommentVNode("v-if", true),
...
var _sfc_main97 = defineComponent({
  __name: "index",
  setup(__props) {
    const ns4 = useNamespace("sidebar-trigger");
    const { t } = useLocale();
    const active = ref(false);
    const isLt960 = useMediaQuery("(max-width: 960px)");
    const toggleSideBar = () => {
      const layoutDom = document.querySelector(`.${ns4.join("layout")}`);
      layoutDom && layoutDom.classList.toggle(ns4.is("sidebar-collapse"));
      if (!active.value) {
        active.value = true;
        setTimeout(() => {
          active.value = false;
    ...
    onMounted(async () => {
      ...
      docDom == null ? void 0 : docDom.classList.add("sidebar-trigger-transition");
    });
    return (_ctx, _cache) => {
      return !unref(isLt960) ? renderSlot(_ctx.$slots, "default", {
        ...
        createBaseVNode("div", {
          class: normalizeClass([unref(ns4).b(), unref(ns4).is("active", active.value)]),
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass([unref(ns4).join("right-bottom-button__button")])
            },
            [
              createVNode(unref(_sfc_main14), { icon: unref(autoWidthIcon) }, null, 8, ["icon"])
            ],
            2
            /* CLASS */
          )
        ...
        [
          ...
          createVNode(unref(Layout), {
            class: normalizeClass([
              ...
              unref(ns4).has("sidebar-trigger", unref(teekConfig).sidebarTrigger)
            ])
          }, createSlots({
            ...
            "doc-before": withCtx(() => [
              ...
              unref(teekConfig).sidebarTrigger ? (openBlock(), createBlock(unref(_sfc_main97), { key: 3 }, {
                default: withCtx((scope) => [
...
var index = {
  ...
  Layout: TeekConfigProvider(_sfc_main98),
...
export {
  ...
  _sfc_main74 as TkCodeBlockToggle,
  ...
  _sfc_main78 as TkRightBottomButton,
  _sfc_main18 as TkRiskLinkPage,
  _sfc_main81 as TkSegmented,
  _sfc_main80 as TkSegmentedItem,
  _sfc_main97 as TkSidebarTrigger,
  _sfc_main90 as TkSwitch,
  _sfc_main95 as TkThemeEnhance,
  _sfc_main85 as TkThemeEnhanceBaseTemplate,
  _sfc_main4 as TkTitleTag,
  _sfc_main19 as TkTransitionCollapse,
  _sfc_main16 as TkVerifyCode,
  _sfc_main96 as TkVpContainer,
  WhatsApp,
